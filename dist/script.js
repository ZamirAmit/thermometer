...
/*
// this is for the storyline JS trigger:

document.getElementById("current_temp").value = 4;
document.getElementById("temperature").style.height = (range.value - config.minTemp) / (config.maxTemp - config.minTemp) * 100 + "%";
temperature.dataset.value = range.value;
setTimeout(setTemperature, 1000);
*/